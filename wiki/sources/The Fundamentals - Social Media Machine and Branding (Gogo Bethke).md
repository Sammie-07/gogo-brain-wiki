---
type: source
original: "[[Clippings/The Fundamentals - Social Media Machine and Branding (Gogo Bethke).md]]"
author: "[[Gogo Bethke]]"
published: —
ingested: 2026-07-05
tags: [social-media, personal-branding, productivity, delegation, ai]
---
...
- **The Machine = one-to-many marketing funnel.** One post reaches thousands, lives forever, and feeds traffic from all platforms (YouTube, Instagram, Facebook, LinkedIn, TikTok, email) into one destination — your website/landing page — where you close them.
- **Scheduled-but-invisible posting cadence.** Same audience/concept each weekday, different content: Mon = sellers ("what's your home worth"), Tue = anyone, Wed = buyers ("search for homes"), Thu = anyone, Fri = agents (agent attraction / "partner with me"), Sat = open houses, Sun = emotional post. Gogo rejects third-party schedulers — they kill reach; "scheduled" means a fixed weekly rhythm, not automation.
- **Beat the algorithm with [[ManyChat]] keywords.** Instagram/Facebook suppress posts with direct links and show your post to <2% of followers. Comment-triggered keywords (e.g. "comment SOCIAL") auto-DM the link instead. Gogo once lost community access for over-triggering automation, so she now mixes keywords and occasional direct links.
- **Business on business, then share to personal.** Doing business on a personal account caps you (~5,000 followers, no ads, no privacy). Run it on a business page; auto-share to personal so friends still see it.
- **Brand consistency = recognition (the "Target test").** Same name, same bio, same current photo across every platform, yard sign, email signature, business card — until strangers recognize you at the grocery store. Photo must actually look like you today (no decades-old grad photo).
- **Own yourname.com and your Instagram handle — check both before naming any brand.** Domains are ~$11/year ("take a night shift at Taco Bell, still buy your .com"). Buy your kids' .com too. Only one owner is possible on IG + .com; everywhere else multiples are fine.
- **Never name your LLC after your brand.** It "serves you up on a silver platter" to anyone who wants to sue you and see what you own. Brand ≠ LLC. Hide assets via holding companies and trusts ("a box in a box in a box") using a firm like [[Anderson Advisors]]; Gogo holds 27 LLCs under an unlimited plan.
- **All roads lead to yourname.com.** Every venture gets its own site but feeds back to the personal hub. Gogo's [[gogobethke.com]] funnels [[Gogo's Real Estate Team]], [[GoGet'Em Community]], [[The Circle (Coaching Program)]], the [[Gopreneur Podcast]], boot camps, agent attraction, etc.
...
- **GGTC program structure & offers.** Base is $79/mo or $799/yr; the "Done With You" upgrade gives access to Gogo's 14 assistants on the weekly live tech call for 52 weeks at $400/mo (at the time of this source the call ran twice weekly; as of Sep 2026 GGTC runs one, Tuesdays, and the former Wednesday call moved to [[#teamgogo]]) ($4,800/yr, payment plans available) — framed against one VA costing ~$12,000/yr. Tools: brand tracker (bookmark + monthly follower/view logging on the 1st), shared posting calendar, the "100 Audit Club" (qualify for a personal brand-audit live), 10% affiliate program, Mon–Fri 9–5 ET chat support.

## Quotes
> "If you start skipping bricks and you're going to start putting a roof on a house that has no foundation, it is going to fall apart... mark my words, I guarantee you it will not work if you don't follow every single step as we grow."

> "Business happens on business, then you share it to personal, then your people going to take you seriously."
