...
### The AI-Run Company — departments, "rented land" & build-your-brain ([[Carrie Soave]], Sep 2026)
Her **second** appearance (see [[How to Triple Your GCI with AI Agents — The AI-Run Company (Carrie Soave, teamgogo Sep 2026)]]) extends the Command-Center thesis from *how to run one AI* to *how to run a whole company with AI*.
- **Run your business as a company:** **7 income-producing departments** (Market Intelligence, Marketing & Visibility, Database & Relationships, Lead Conversion, Sales, Transaction Delivery, Client Expansion) + **4 capacity-protecting departments** (Operations, Finance, HR, Management). Assign AI workflows to each. Her firm runs ~9 departments at ~$250K/mo with 3–4 humans.
- **Implementation gap = the opportunity:** "82% of agents use AI, only 17% say it made an impact. We don't have an adoption problem, we have an implementation problem." A business where *you* are the system stops every time you do.
- **Don't build on rented land:** models get banned/deprecated/changed, so keep your systems, context, data and guardrails **outside any single model** — on your desktop + personal cloud/Drive — so you can swap models with zero downtime. (Reinforces Gogo's own [[#The AI "second brain"|second-brain]] + [[#Shared-drive default for team AI output|shared-drive]] discipline.)
- **Build-your-AI-brain (5 steps):** (1) have Claude/ChatGPT interview you about your whole business (who you are, market, numbers, systems, tool stack, processes, voice, rules, philosophies, past/present/goals) and **generate a comprehensive personal wiki**; (2) save every file to desktop **and** cloud; (3) connect all tools via Customize/plugins; (4) open it as a Cowork/work **project**, attach the wiki, and set it to auto-check your apps and **update the wiki on the last day of each month** (first autonomous workflow); (5) ask for the top 5 highest-impact workflows to build next. *(This is the same pattern as the very brain you're reading.)*
- **4 phases for commission agents:** (1) CRM / speed-to-lead / pipeline reactivation / drips; (2) marketing & socials (AEO/GEO/SEO, funnels, ads) + AI twins ([[Halo|HeyGen/Higgsfield]]-style on autopilot); (3) client-experience workflows; (4) operations dashboard (transactions, commissions, due dates, expenses).
- **Client experience is the moat**, delivered at scale by AI; **speed-to-lead** under 5 minutes via AI voice callers/bots. Cost: ~$30K/mo payroll ≈ $300–$1,000/mo in tech.
...
3. **Prompt discipline:** give full context on the goal *first*, or AI will justify your existing framing instead of doing the reframing work you actually need. A concrete instance (from [[The Circle Coaching — Accountability Cadence, First-Come Lead Distribution and Naming for Life (de-identified)]]): when brainstorming a downline brand name, **Claude/AI defaults to a *local* real-estate framing and keeps tying the brand to a location** — you must explicitly tell it you operate in every US state + 27 countries and attract agents globally, or "it won't listen." The model doesn't understand eXp's non-local model until you give it that context.
...
## Local-News AI Agent, Paid-Only Privacy & AI-Email Oversight (Circle coaching)
...
**Build a local-news AI agent.** Stand up an agent (in [[Claude]]) whose only job is to **scan your farm town's news every morning** — layoffs, new hirings, new restaurants/schools/hospitals, a big employer (e.g. an Amazon warehouse) moving in — and send you a report. You skim it and decide what's worth a post or an email. It feeds the [[Lead Generation#Keyword Automation Discipline, Tagging & the ROI Reframe (Circle coaching)|give-first local-news email]] to your tagged buyers, and an assistant/VA can pre-flag the best items. Cheap to build and worth doing at the [[The Circle|Circle]] "tech call," not on your one precious monthly coaching hour.

**Paid-only privacy compliance — non-negotiable for licensed agents.** Never upload client PII (emails, contact info, transaction details) to a **free/general AI** — that data flows into a shared model and is effectively a breach and a brokerage-policy violation. *"If you give a free AI access to your client's email, it's pretty much being hacked."* Use **paid, private AI only** (where the data stays with you) for anything touching client information — the same discipline behind [[#Projects segregate memory (Thomas Heimann)|project-segregated memory]].

**AI email assistants need a human in the loop.** They will mis-file messages, mark real mail as spam, auto-create folders you didn't know about, or leave a reply sitting in draft that looks sent — so you miss the email entirely. Budget **~1.5–2 months of double-checking** before you trust the flow. Powerful, but "at first it's a show" — a concrete instance of the [[#Back of House vs. Front of House — the Human in the Loop (Adam Gillespie)|human-in-the-loop]] rule applied to the inbox.

## The Sister-City Article Cheat, GBP-as-AI-Authority & AI Website Builders (Kirby Chan)

*Source: [[The AI System for One Listing Appointment a Day (Kirby Chan)]]. [[Kirby Chan]]'s second #teamgogo / [[GoGet'Em Community]] training — the execution layer under his [[#AI SEO & Getting Cited by AI / GEO (Kirby Chan)|AI-SEO/GEO thesis]].*

**The Claude "sister-city" competitor-cloning cheat.** To write an article that ranks without starting from scratch: find a **sister city** similar to yours (e.g., Seattle), Google "[sister city] [your niche]" (e.g., "Seattle downsizing"), take the **top 1–3 ranking agent pages**, and paste them into [[Claude]]/ChatGPT with *"analyze these, copy the good, improve the bad SEO, then write me an article for [my city] using my standards."* Because the model is grounded in pages already ranking #1, the output ranks. Run it inside a saved **project** that holds your standards.

**Your goal is the AI Overview, not just #1 on Google.** *"Nobody goes to AI to search for an agent — they go to AI to assist them with what they're going through in life."* A first-time buyer asks AI "what do I do?", it teaches them, then they ask "find me a good agent/mortgage broker," and it names **whoever published the most content on that niche + city.** Being *cited* by ChatGPT/Gemini/Claude beats a blue-link ranking. Test it directly: ask ChatGPT to "find an agent in [city] to refer for [niche]" — **win ~50% of the time and you book appointments.** This is the same GEO reality as [[#AI Search & "Search Everywhere Optimization" (Kalie Kinsella)|Kinsella's trust chain]] and [[#Gogo's "second brain" / Niche Finder|the Niche Finder]] (AI reads social + content, then recommends).

**One asset a day.** AI weights four asset types — **blog, article, press release, video.** Produce **one a day** (~1 hour), each an evergreen niche **service page** backed by supporting **blogs**, mixing AI-drafted + human edit (add photos, client stories, testimonials so it's unique and can't be duplicated). Volume on a single niche is what makes the AI recommend you.

**Brokerage sites are invisible to AI; AI website builders fix it cheaply.** A templated brokerage site won't rank (Google won't rank an identical template it gave everyone). Options: own `yourname.com`; an **eXp Lofty** site + ~**$39.50/mo** for the blogs/SEO feature; or an **AI text-to-website service** (~$99/mo, hosting included, "text your AI web developer" via a phone number) that builds **AI-searchable sites in ~2.5 minutes** — sites "built by AI for AI" are SEO-optimized from creation. (The [[Lead Generation#Reverse Prospecting, One-Niche-at-a-Time & Live GBP Tactics (Kirby Chan)|GBP + reverse-prospecting mechanics]] carry the rest.)

## Halo — the AI Website Agency You Run by Text (Nick Krem and Eric Post)

*Source: [[Halo — The AI Website Agency You Run by Text (Nick Krem and Eric Post)]]. [[Eric Post]] (founder/architect of [[Halo]]) + [[Nick Krem]] (AI strategist), a #teamgogo / [[GoGet'Em Community]] live workshop. This is the fully-demoed product behind the "text your AI web developer, ~$99/mo, AI-searchable site in ~2.5 min" tool [[Kirby Chan]] referenced — [[#The Sister-City Article Cheat, GBP-as-AI-Authority & AI Website Builders (Kirby Chan)|see his AI-website-builder note]].*

**Halo is a marketing agency, not a chatbot.** One chat assistant (your "AI chief marketing officer") commands **~30 "AI employees"** — web designer, video crew, graphic designer, copywriter, researcher, SEO/AEO/GEO strategists, marketing coordinator. It used **51 different AIs in the last 30 days** and picks the best model per task, so you carry no APIs or separate subscriptions. You **delegate by text** ("here's my new listing, here's the address"; "translate my site to Spanish"; "turn this selfie into a headshot") and it does the work and reports back — "put your phone down and go back to your business." This is the [[#Claude as a Command Center (Carrie Soave)|operator, not spectator]] thesis packaged into one text thread.

**Built by AI for AI — the GEO/AEO play made turnkey.** Every site is optimized for AI search from creation, handling `llms.txt`, JSON, and schema so the agent never has to. It fixes the exact problem in [[#AI SEO & Getting Cited by AI / GEO (Kirby Chan)|Kirby Chan's GEO thesis]] and [[#AI Search & "Search Everywhere Optimization" (Kalie Kinsella)|Kinsella's trust chain]]: **most brokerage/CRM sites actively block AI crawlers** and are "built for yesterday," so agents blogging there are never crawled or cited. Proof shown live: a week-old site cited by AI **9,000+ times**; agents closing **$100M+** in 3 months from Halo sites / AI discovery; **1,135+** leads straight to CRM + phone; a 700-page site that connected Google Search Console, had Halo **fix ~14,000 bugs, and doubled traffic in a week.**

**Three site types + the hub-and-spoke authority graph.** Niche, authority, and property sites (event/landing/recruiting sites coming). The strategy is the **authority graph**: `yourname.com` is the hub; niche + property + agent-attraction pages are cross-linked spokes, which is what makes the AI recognize you as the local authority and recommend you. Same "own your platform, don't rent social" logic as [[Personal Branding#Brand Architecture, the One-Word Pillar & Dissolution Positioning|brand architecture]] — see [[Personal Branding#The Hub-and-Spoke Authority Graph (Halo / Eric Post)|the hub-and-spoke authority graph]].

**14 gates, copyright-safe, human still posts.**
- **14 compliance gates** before publishing (fair-housing auditor, fair-lending auditor, broken-link/redirect checks) so output is "a thoughtful generation, not AI slop."
- First-generation images are **AI-generated (full license, copyright-safe)**; swap in your own photos/video by texting them.
- **Does NOT auto-post to social** — platforms penalize syndicated content and third-party auto-posters "get zilch results." Halo makes the **asset**; you copy-paste. The "waterfall" removes the friction of *what to make*, not the act of posting — the same [[#The AI-Content Throttle — "Everyone Can Smell AI on the Scroll" (Jesse Dau)|keep-the-human-on-the-feed]] conclusion. (Gogo's workaround: add a VA as an Instagram *additional user* — no password shared — to post from inside the app.)

**Content pillars (Eric's reframe).** Old pillars were entertain/inform/educate. The new three: (1) **friction points / life triggers** (job, baby, downsize) that push someone to transact; (2) the **education** they need as a result; (3) **why choose you.** "If you don't know what you stand for, how will the internet know how to recommend you?" And **"riches are in the niches" is now more true than ever** because there is ~**15,000× more content online** than 18 months ago — volume on a single niche is what earns the AI recommendation (rhymes with [[#The Sister-City Article Cheat, GBP-as-AI-Authority & AI Website Builders (Kirby Chan)|Kirby Chan's "one asset a day on one niche"]]).

**Also a coding agent + translator.** Rebuilds a site from a pasted sitemap; connect Google Search Console, paste the errors, it fixes them; one-toggle full-site translation (Spanish/Russian/Dutch…) for underserved-language niches (same edge as [[#AI SEO & Getting Cited by AI / GEO (Kirby Chan)|Kirby Chan's foreign-language SEO]]); 21 style systems; accessibility-ready; auto mobile-optimized. Marketplace push-button add-ons: lead quiz (300+ built; top converter), animations, hero video, CRM webhook, GoHighLevel, Zapier, Google Analytics.

**Why AI still needs the human (the math caveat).** Eric's framing echoes the brain's [[#Back of House vs. Front of House — the Human in the Loop (Adam Gillespie)|human-in-the-loop]] thread: LLMs are "built to produce plausible language, not fundamental truth" — they give the *illusion* of doing math (Jason Dupree's ChatGPT got his son's honors-math problem wrong twice). The winning combo the AI-powered consumer wants is **trust + ease** — AI scale plus a real human.

**Pricing / access:** **$99/mo** = 2 full sites, **1,000 pages**, unlimited edits, unlimited automations, nationwide referral network (coming). **Free trial via Gogo:** live hosted site + **5 edits** (text "Gogo" to the number / scan the QR). Gogo has **removed #teamgogo's old paid funnel ($300) / website ($2,000–$3,000) build service** because Halo replaces it (she estimates $200K+ spent on websites over her career).

**Nick's Agent-Attraction ninja tactic.** Text the AI daily: *"research the #1 question a producing agent asks when considering a brokerage change."* It returns the question; you text back your answer; it writes a niche blog answering it → you become the cited source when agents ask AI that question. One user booked **two appointments on day one.** (An agent-attraction application of the [[Lead Generation#The Agent-Attraction Daily-Blog Play (Nick Krem / Halo)|daily-blog play]].)

## AEO / GEO — optimize for AI answers, not just Google (Sep 2026)

*Sources: [[teamgogo Roundtable — Halo AI Websites, Niche Finder and the NAR Reality Check (Sept 2026)]], [[The Chaos-Free Agent — Google Workspace as Your Operating System (Kalie Kinsella)]].*

The search layer is shifting from **SEO** (rank on Google) to **AEO** (AI Engine Optimization — get surfaced by ChatGPT/Claude/Gemini). The catch: brokerage-provided sites (eXp's **Bold Trail**, formerly **KVCore**, ~10 years old) predate AI and **block AI crawlers** — [[Halo]]'s AEO checker scores them an "F," so ask ChatGPT "best realtor in South Florida" and those agents don't appear. Fix: own your name/data/leads on an AI-readable site (Halo, or a [[Google Workspace for Real Estate Agents|Google Site]]). **Gemini + Google AI Studio** (bundled in Workspace) can build automations from plain-English outcomes and replace a standalone AI assistant — reserve AI for the mundane/repeatable, not for judgment. See also [[Kalie Kinsella]]'s "Build it, Prove it, Feed it" GBP work.
